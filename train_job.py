...
def main():
    ...
    if (not _expected_build) or (_expected_build != _utils_build) or _missing_utils or _dashboard_tag != "dashboard-v13.4.7-live-shadow-bets-fast-ui" or _utils_tag != "utils-v13.4.7-live-shadow-bets-fast-ui" or _wrapper_tag != "wrapper-v13.4.7-live-shadow-bets-fast-ui":
        raise RuntimeError(
