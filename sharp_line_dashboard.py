...
def fetch_scores_and_backtest(sport_key, df_moves=None, days_back=3, api_key=API_KEY, model=None):
    ...
    # === 4. Build score rows and merge keys
    score_rows = []
    completed_keys = set()
    ...
    if df.empty:
        st.warning("ℹ️ No sharp picks match completed games.")
        return df
